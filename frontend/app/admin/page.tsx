      ...
      {report && (
        <div className="mt-6 border border-gray-200 rounded-lg overflow-hidden">
          ...
          <div className="p-4 space-y-3">
            ...
            <button onClick={() => window.location.href = "/"} className="mt-4 w-full inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-[#24408e] text-white text-sm font-medium rounded-md hover:bg-[#1d3472] disabled:opacity-50 disabled:cursor-not-allowed transition-colors">Go to the home page -&gt;</button>
          </div>
        </div>
      )}
    </div>
